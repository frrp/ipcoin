...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0439abb987B749A936A3259C0BC10B6BBD04CEC087AAEDBB99B22D37112C88E02D7716DF6E4B89CE6FC22AC4D7DB2A7E6641FA8F9C4A8A6EBA04E99B1229EDC7DB");
        nDefaultPort = 8433;
        nRPCPort = 8432;
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "16 Jan 2014 IPCoin finished";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0439abb987B749A936A3259C0BC10B6BBD04CEC087AAEDBB99B22D37112C88E02D7716DF6E4B89CE6FC22AC4D7DB2A7E6641FA8F9C4A8A6EBA04E99B1229EDC7DB") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1389855163;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 2106484631;

        hashGenesisBlock = genesis.GetHash();
	
        assert(hashGenesisBlock == uint256("0x0000000025982d5eda5f3fae4ed2bf00a0c3c827bf81d97dd87a04a7c4a6d7ab"));
        assert(genesis.hashMerkleRoot == uint256("0x6f9a8ae67fd33540d1b6a43093ca8b3b27e8cb306ade0f16c0f734701aa1a3da"));

        vSeeds.push_back(CDNSSeedData("ipcoin.mechanicalamoeba.com", "ipcoin.mechanicalamoeba.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("ipcoin.mechanicalamoeba.com", "testnet-ipcoin.mechanicalamoeba.com"));
