...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to IPCoin.", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where IPCoin will store its data.", 0, QApplication::UnicodeUTF8));
        sizeWarningLabel->setText(QApplication::translate("Intro", "IPCoin will download and store a copy of the IPCoin block chain. This will grow over time. The wallet will also be stored in this directory.", 0, QApplication::UnicodeUTF8));
